                    				...
                    				<table class="table table-bordered">
                    					...
                    					<tbody>
                    						...
                    						for ($i=0; $i < count($_SESSION['cart']); $i++) { 
                    							$select = "SELECT * FROM shoe_shop_product where product_id = {$_SESSION['cart'][$i]}";
                    							$query = mysqli_query($conn, $select);
                    							$j = $i;
                    							while ($res = mysqli_fetch_assoc($query)) { 
                    					    ...
                    					    <tr>
                    					    	...
                    					    	<td colspan="2" id="total_amount"><span>Rs. <?php if ($printCount == 0){echo 0;} else {echo $total_amount;}?>
