    ...
    <div class="dashboard-main-wrapper">
       ...
       <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="index.php">ONLINE SHOE SHOP</a>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="card bg-primary">
                            <div class="card-body">
                                ...
                                <?php
                                $select_users = "SELECT * FROM shoe_shop_users_registrations";
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="card bg-brand">
                            <div class="card-body">
                                ...
                                <?php
                                $select_category = "SELECT * FROM shoe_shop_category";
                                $query_category = mysqli_query($conn, $select_category);
                                $res_category = mysqli_num_rows($query_category);
                                ?>
                                <p class="card-text text-white">Number of categories = <?php echo $res_category;?>.</p>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="card bg-secondary">
                            <div class="card-body">
                                ...
                                <?php
                                $select_product = "SELECT * FROM shoe_shop_product";
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="card bg-success">
                            <div class="card-body">
                                ...
                                <?php
                                $select_orders = "SELECT * FROM shoe_shop_orders";
                                $query_orders = mysqli_query($conn, $select_orders);
                                $res_orders = mysqli_num_rows($query_orders);
                                ?>
                                <p class="card-text text-white">Number of orders = <?php echo $res_orders;?>.</p>
