                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered first">
                                        ...
                                        <tbody>
                                            ...
                                            $select = "SELECT shoe_shop_product.*, shoe_shop_category.category_name FROM shoe_shop_product JOIN shoe_shop_category ON shoe_shop_product.product_category = shoe_shop_category.category_id";
