...
if ($file_name != "") {
    ...
    $insert = "INSERT INTO shoe_shop_category (category_name, category_image) values ('$category_name', '$new_file_name')";
    mysqli_query($conn, $insert);
    header('Location: add_category.php?add_msg=1');
}
elseif ($file_name == "") {
	$default = "default-image.jpeg";
	$insert = "INSERT INTO shoe_shop_category (category_name, category_image) values ('$category_name', '$default')";
	mysqli_query($conn, $insert);
    header('Location: add_category.php?add_msg=1');
}
?>